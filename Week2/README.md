...
* Contact form layout
* Hover effects and transitions on buttons and links
...
* Element selectors for headings, paragraphs, and sections
* Hover effects using `:hover`
* CSS variables for consistent colors
* Flexbox for navigation and hero layout
* CSS Grid for skills and project cards
...
* Added Google Fonts
* Defined a consistent color palette
* Styled headings and text

### Day 3 – Layout & Spacing

* Implemented Flexbox and CSS Grid
* Added margins, padding, and spacing

### Day 4 – Interactive Elements

* Added hover effects
* Applied transitions for smoother interactions
...
* Styled cards, forms, and buttons
* Improved visual hierarchy and presentation
...
* Building responsive interfaces with Flexbox and Grid
